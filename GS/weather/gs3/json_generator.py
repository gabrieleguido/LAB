...
try:
    with open("gs3_html.html", "r", encoding="utf-8") as html_file:
        html_text = html_file.read()
    
    with open("gs3.txt", "r", encoding="utf-8") as golden_file:
        golden_text = golden_file.read() 

    json_entry = {
        "url": "https://weather.com/it-IT/tempo/10giorni/l/104b5c3a7e17868e40f84026b44fd565a02ee18193bb030a5cbd3076e58c01bc",
        "domain": "www.weather.com",
        "title": "Previsioni meteo per 10 giorni- Roma, città metropolitana di Roma Capitale",
        "html_text": html_text,
        "gold_text": golden_text
    }

    with open("gs3.json", "w", encoding="utf-8") as result:
