...
try:
    with open("gs6_html.html", "r", encoding="utf-8") as html_file:
        html_text = html_file.read()
    
    with open("gs6.txt", "r", encoding="utf-8") as golden_file:
        golden_text = golden_file.read() 

    json_entry = {
        "url": "https://www.nbcnews.com/sports/soccer/philadelphia-world-cup-fan-experience-fifa-rcna342497",
        "domain": "www.nbcnews.com",
        "title": "Philadelphia plans 'surprise and delight element' at FIFA World Cup Fan Festival",
        "html_text": html_text,
        "gold_text": golden_text
    }

    with open("gs6.json", "w", encoding="utf-8") as result:
