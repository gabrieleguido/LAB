...
try:
    with open("gs8_html.html", "r", encoding="utf-8") as html_file:
        html_text = html_file.read()
    
    with open("gs8.txt", "r", encoding="utf-8") as golden_file:
        golden_text = golden_file.read() 

    json_entry = {
        "url": "https://www.nbcnews.com/health/health-news/hantavirus-cruise-ship-docking-cape-verde-hondius-who-rcna343415",
        "domain": "www.nbcnews.com",
        "title": "Cruise ship at center of suspected deadly hantavirus outbreak refused permission to dock",
        "html_text": html_text,
        "gold_text": golden_text
    }

    with open("gs8.json", "w", encoding="utf-8") as result:
