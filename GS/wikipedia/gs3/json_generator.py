...
try:
    with open("Laika_html.html", "r", encoding="utf-8") as html_file:
        html_text = html_file.read()
    
    with open("Laika.txt", "r", encoding="utf-8") as golden_file:
    ...
    with open("Laika.json", "w", encoding="utf-8") as result:
