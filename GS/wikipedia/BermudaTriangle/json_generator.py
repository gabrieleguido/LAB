...
try:
    with open("BermudaTriangle_html.html", "r", encoding="utf-8") as html_file:
        html_text = html_file.read()
    
    with open("BermudaTriangle.txt", "r", encoding="utf-8") as golden_file:
    ...
    with open("BermudaTriangle.json", "w", encoding="utf-8") as result:
